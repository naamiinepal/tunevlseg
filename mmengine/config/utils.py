...
class ImportTransformer(ast.NodeTransformer):
    ...
    def visit_ImportFrom(
    ...
    ) -> list[ast.Assign] | ast.ImportFrom | None:
        ...
        for alias_node in node.names:
            ...
            lineno = alias_node.lineno if hasattr(alias_node, "lineno") else node.lineno
            if alias_node.name == "*":
    ...
    def visit_Import(self, node) -> ast.Assign | ast.Import:
