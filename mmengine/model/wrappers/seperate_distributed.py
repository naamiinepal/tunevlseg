...
class MMSeparateDistributedDataParallel(DistributedDataParallel):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        for name, sub_module in module._modules.items():
            ...
            if next(sub_module.parameters(), None) is None or all(
                not p.requires_grad for p in sub_module.parameters()
            ):
    ...
    def train_step(
        self, data: dict | tuple | list, optim_wrapper: OptimWrapperDict
