...
EnhancedBatchInputs = list[torch.Tensor | list[torch.Tensor]]
...
DATA_BATCH = Union[
    dict[str, EnhancedBatchInputs | EnhancedBatchDataSamples], tuple, dict
]
...
class BaseTTAModel(BaseModel):
    ...
    def test_step(self, data):
        ...
        return self.merge_preds(list(zip(*predictions, strict=False)))  # type: ignore
