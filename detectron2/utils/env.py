...
def setup_custom_environment(custom_module) -> None:
    ...
    assert hasattr(module, "setup_environment") and callable(
        ...
        f"Custom environment module defined in {custom_module} does not have the "
        "required callable attribute 'setup_environment'."
    )
    module.setup_environment()


def fixup_module_metadata(module_name, namespace, keys=None) -> None:
    ...
    def fix_one(qualname, name, obj) -> None:
        ...
        if mod is not None and (mod.startswith((module_name, "fvcore."))):
