...
__all__ = ["FPN", "build_resnet_fpn_backbone", "build_retinanet_resnet_fpn_backbone"]
...
class FPN(Backbone):
    ...
    def forward(self, x):
        ...
        for idx, (lateral_conv, output_conv) in enumerate(
            zip(self.lateral_convs, self.output_convs, strict=True),
        ):
        ...
        return dict(zip(self._out_features, results, strict=False))
...
class LastLevelP6P7(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, in_feature="res5") -> None:
        super().__init__()
        self.num_levels = 2
