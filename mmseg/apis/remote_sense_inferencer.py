...
class RSImage:
    ...
    def read(self, grid: list | None = None) -> np.ndarray:
    ...
    def write(self, data: np.ndarray | None, grid: list | None = None):
        """Write image data.
    ...
    def create_seg_map(self, output_path: str | None = None):
...
class RSInferencer:
    ...
    def write(self, image: RSImage, output_path: str | None = None):
