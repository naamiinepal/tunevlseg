...
class AttentionStore:
            ...
            for key in self.attention_store:
                self.attention_store[key] = [
                    ...
                    for stored, step in zip(
                        self.attention_store[key], self.step_store[key], strict=False
                    )
                ]
        self.step_store = self.get_empty_store()
    ...
    def get_average_attention(self):
        ...
        return {key: list(self.step_store[key]) for key in self.step_store}
...
class UNetWrapper(nn.Module):
    ...
    def forward(self, x, timesteps=None, context=None, y=None, **kwargs):
        ...
        _hs, _emb, out_list = self._unet_forward(
...
class TextAdapter(nn.Module):
    ...
    def forward(self, texts, gamma):
        ...
        return texts + gamma * texts_after
...
class VPD(BaseModule):
    ...
    def __init__(
        ...
        pad_shape: int | list[int] | None = None,
        pad_val: int | list[int] = 0,
        ...
        if pad_shape is not None and not isinstance(pad_shape, list | tuple):
    ...
    def forward(self, x):
        ...
        return self.unet(latents, t, context=c_crossattn)
