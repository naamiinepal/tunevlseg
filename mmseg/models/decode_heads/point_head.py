...
class PointHead(BaseCascadeDecodeHead):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            ...
            norm_cfg=norm_cfg,
            act_cfg=act_cfg,
            init_cfg={"type": "Normal", "std": 0.01, "override": {"name": "fc_seg"}},
            **kwargs,
        )
    ...
    def loss(
        self, inputs, prev_output, batch_data_samples: SampleList, train_cfg, **kwargs
    ):
    ...
    def predict(
        self, inputs, prev_output, batch_img_metas: list[dict], test_cfg, **kwargs
    ):
