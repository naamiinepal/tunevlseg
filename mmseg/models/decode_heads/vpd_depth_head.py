    ...
    def __init__(
        ...
        conv_layers.extend(
            (
                ...
                build_norm_layer({"type": "BN"}, out_channels)[1],
...
class VPDDepthHead(BaseDecodeHead):
    ...
    def __init__(
        ...
        fmap_border: int | Sequence[int] = 0,
        align_corners: bool = False,
        loss_decode: dict | None = None,
        init_cfg=None,
    ):
        if init_cfg is None:
            init_cfg = {
    ...
    def forward(self, x):
        ...
        return torch.sigmoid(out) * self.max_depth
