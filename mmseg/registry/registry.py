...
TRANSFORMS = Registry(
    "transform", parent=MMENGINE_TRANSFORMS, locations=["mmseg.datasets.transforms"]
)
...
MODEL_WRAPPERS = Registry(
    "model_wrapper", parent=MMENGINE_MODEL_WRAPPERS, locations=["mmseg.models"]
)
...
OPTIMIZERS = Registry(
    "optimizer", parent=MMENGINE_OPTIMIZERS, locations=["mmseg.engine.optimizers"]
)
...
VISUALIZERS = Registry(
    "visualizer", parent=MMENGINE_VISUALIZERS, locations=["mmseg.visualization"]
)
# manage visualizer backend
VISBACKENDS = Registry(
    "vis_backend", parent=MMENGINE_VISBACKENDS, locations=["mmseg.visualization"]
)

# manage logprocessor
LOG_PROCESSORS = Registry(
    "log_processor", parent=MMENGINE_LOG_PROCESSORS, locations=["mmseg.visualization"]
)
