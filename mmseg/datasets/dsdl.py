...
class DSDLSegDataset(BaseSegDataset):
    ...
    def __init__(
        self,
        specific_key_path: dict | None = None,
        pre_transform: dict | None = None,
        used_labels: Sequence | None = None,
        **kwargs,
    ) -> None:
        if pre_transform is None:
            pre_transform = {}
        if specific_key_path is None:
            specific_key_path = {}
        ...
        loc_config = {"type": "LocalFileReader", "working_dir": ""}
    ...
    def load_data_list(self) -> list[dict]:
        ...
        if self.used_labels:
            ...
            self._metainfo["classes"] = ("background", *self.dsdldataset.class_names)
        data_list = []

        for _i, data in enumerate(self.dsdldataset):
            datainfo = {
    ...
    def get_label_map(self, new_classes: Sequence | None = None) -> dict | None:
