...
class NYUDataset(BaseSegDataset):
    ...
    def __init__(
        self, data_prefix=None, img_suffix=".jpg", depth_map_suffix=".png", **kwargs
    ) -> None:
        if data_prefix is None:
            data_prefix = {"img_path": "images", "depth_map_path": "annotations"}
        super().__init__(
    ...
    def load_data_list(self) -> list[dict]:
        ...
        return sorted(data_list, key=operator.itemgetter("img_path"))
