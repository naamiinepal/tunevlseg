...
def _format_bandwidth(volume: float or int, time_us: int):
    ...
    if mb_per_sec >= 1024.0:
        return f"{mb_per_sec / 1024.0:.3f} GB/s"
    return f"{mb_per_sec:.3f} MB/s"
...
class ProfilerContext:
    ...
    def __init__(
        self, profilers: list[BaseProfiler] | None = None, enable: bool = True
    ):
        self.enable = enable
    ...
    def to_file(self, log_dir: str | Path):
