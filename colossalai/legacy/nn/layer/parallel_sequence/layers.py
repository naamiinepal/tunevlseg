...
class TransformerSelfAttentionRing(nn.Module):
    ...
    def forward(self, hidden_states, attention_mask):
        ...
        sub_seq_length, batch_size, _hidden_size = hidden_states.size()
        ...
        key_layer = key_layer.view(
            key_layer.size(0), output_size[0] * output_size[1], -1
        )
        ...
        attention_scores = RingQK.apply(
            query_layer.transpose(
                0, 1
            ).contiguous(),  # [batch_size * num_heads, sub_seq_len, head_size]
            key_layer.transpose(
                0, 1
            ).contiguous(),  # [batch_size * num_heads, sub_seq_len, head_size],
            batch_size,
