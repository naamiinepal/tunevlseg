...
from colossalai.legacy.tensor import (
    ColoTensorSpec,
    ComputePattern,
    ProcessGroup,
    ShardSpec,
...
class ParallelCachedEmbeddingBag(CachedEmbeddingBag):
    def __init__(
        ...
        self.partition_start_index, self.partition_end_index, _divisible = (
            get_partition(embedding_dim, self.rank, self.world_size)
        )
