...
def _communicate(
    object_send_next: torch.Tensor | list[torch.Tensor] = None,
    object_send_prev: torch.Tensor | list[torch.Tensor] = None,
    recv_prev: bool = False,
    recv_next: bool = False,
    recv_prev_shape: torch.Size | list[torch.Size] = None,
    recv_next_shape: torch.Size | list[torch.Size] = None,
