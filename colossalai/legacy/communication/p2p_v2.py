...
def _cuda_safe_tensor_to_object(
    tensor: torch.Tensor, tensor_size: torch.Size
) -> object:
...
def recv_forward(prev_rank: int | None = None) -> Any:
...
def recv_backward(next_rank: int | None = None) -> Any:
...
def send_forward(output_object: Any, next_rank: int | None = None) -> None:
...
def send_backward(input_object: Any, prev_rank: int | None = None) -> None:
