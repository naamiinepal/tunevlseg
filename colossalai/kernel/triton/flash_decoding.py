...
try:
    from lightllm.models.llama.triton_kernel.flash_decoding_stage1 import (
        flash_decode_stage1,
    )
    from lightllm.models.llama.triton_kernel.flash_decoding_stage2 import (
        flash_decode_stage2,
    )
    ...
    print(
        "install lightllm from https://github.com/ModelTC/lightllm/blob/ece7b43f8a6dfa74027adc77c2c176cff28c76c8"
    )
...
if HAS_LIGHTLLM_KERNEL:
    ...
    def token_flash_decoding(
        q, o_tensor, infer_state, q_head_num, head_dim, cache_k, cache_v
    ):
        BLOCK_SEQ = 256
