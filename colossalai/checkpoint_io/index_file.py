...
class CheckpointIndexFile:
    ...
    @staticmethod
    def from_file(index_path: str | Path):
        """
    ...
    def export(self, json_path: str):
        ...
        with open(json_path, "w", encoding="locale") as f:
    ...
    def get_checkpoint_filenames(self) -> list[str]:
        ...
        checkpoint_files = sorted(set(self.weight_map.values()))
    ...
    def get_param_group_filename(self) -> str | None:
        """
