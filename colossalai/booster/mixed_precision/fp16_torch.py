...
__all__ = ["FP16_Torch_MixedPrecision", "TorchAMPModule", "TorchAMPOptimizer"]
...
class TorchAMPOptimizer(OptimizerWrapper):
    ...
    def step(self, *args, **kwargs) -> float | None:
    ...
    def clip_grad_by_norm(
        ...
        **kwargs,
        ...
        self.unscale_grad()
        super().clip_grad_by_norm(
            max_norm, norm_type, error_if_nonfinite, *args, **kwargs
        )
