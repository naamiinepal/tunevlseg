...
class DistributedLogger:
    ...
    def get_instance(name: str):
        ...
        return DistributedLogger(name=name)
    ...
    def _log(self, level, message: str, ranks: list[int] | None = None) -> None:
        if ranks is None:
    ...
    def info(self, message: str, ranks: list[int] | None = None) -> None:
        """Log an info message.
    ...
    def warning(self, message: str, ranks: list[int] | None = None) -> None:
    ...
    def debug(self, message: str, ranks: list[int] | None = None) -> None:
        """Log a debug message.
    ...
    def error(self, message: str, ranks: list[int] | None = None) -> None:
