...
class NormPoolingHandler(MetaInfoModuleHandler):
    ...
    def get_strategy_generator(self) -> list[StrategyGenerator]:
        ...
        generators = []
        generators.append(
            NormalPoolStrategyGenerator(op_data_mapping, self.device_mesh)
        )
        return generators
    ...
    def get_operation_data_mapping(self) -> dict[str, OperationData]:
        ...
        physical_weight_operand = OperationData(
            name="kernel", type=OperationDataType.ARG, data=self.module.kernel_size
        )
