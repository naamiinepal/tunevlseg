...
class BatchNormStrategyGenerator(StrategyGenerator):
    ...
    def update_compute_cost(self, strategy: ShardingStrategy):
        ...
        backward_compute_cost = (
            backward_weight_compute_cost + backward_activation_compute_cost
        )
        if self.has_bias:
    ...
    def update_memory_cost(self, strategy: ShardingStrategy):
        ...
        fwd_mem_cost = MemoryCost(
            activation=fwd_activation_cost,
            parameter=fwd_parameter_cost,
    ...
    def split_input_batch_1d(self, mesh_dim_0, mesh_dim_1):
        name = (
            f"S{mesh_dim_0}{mesh_dim_1}R = S{mesh_dim_0}{mesh_dim_1}R x R WITH SYNC_BN"
        )
        dim_partition_dict_mapping = {
