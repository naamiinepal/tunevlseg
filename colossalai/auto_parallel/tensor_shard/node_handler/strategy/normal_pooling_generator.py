...
class NormalPoolStrategyGenerator(StrategyGenerator):
    ...
    def enumerate_all_possible_batch_dimensions_dim_partition(
        ...
        dim_partition_list.extend(
            enumerate_all_possible_2d_sharding(mesh_dim_0, mesh_dim_1, 2)
        )
    ...
    def collate_strategies(self) -> list[ShardingStrategy]:
        ...
        dim_partition_list = self.enumerate_all_possible_batch_dimensions_dim_partition(
            0, 1
        )
