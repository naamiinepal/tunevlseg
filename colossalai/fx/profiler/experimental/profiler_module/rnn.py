...
def torch_nn_rnn(
    self: torch.nn.RNNBase, input: torch.Tensor, hx: torch.Tensor | None = None
) -> tuple[int, int]:
    flops = 0
    macs = 0
...
def torch_nn_rnn(
    self: torch.nn.RNNCellBase, input: torch.Tensor, hx: torch.Tensor | None = None
) -> tuple[int, int]:
    flops = 0
    macs = 0
