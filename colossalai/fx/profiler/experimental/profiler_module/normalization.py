...
try:
    ...
    meta_profiler_module.register(apex.normalization.MixedFusedLayerNorm)(
        torch_nn_normalize
    )
    meta_profiler_module.register(apex.normalization.MixedFusedRMSNorm)(
        torch_nn_normalize
    )
