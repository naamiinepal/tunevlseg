...
__all__ = ["auto_set_accelerator", "get_accelerator", "set_accelerator"]
...
_ACCELERATOR_MAPPING = OrderedDict(
    cuda=CudaAccelerator, npu=NpuAccelerator, cpu=CpuAccelerator
)


def set_accelerator(accelerator: str | BaseAccelerator) -> None:
    """
    ...
    if isinstance(accelerator, str):
        ...
        raise TypeError(
            "accelerator must be either a string or an instance of BaseAccelerator"
        )
