...
class OneForwardOneBackwardSchedule(PipelineSchedule):
    ...
    def recv_forward(self, prev_rank: int | None = None) -> Any:
    ...
    def recv_backward(self, next_rank: int | None = None) -> Any:
    ...
    def send_forward(self, output_tensor: Any, next_rank: int | None = None) -> None:
    ...
    def send_backward(
        self, input_tensor_grad: Any, prev_rank: int | None = None
    ) -> None:
