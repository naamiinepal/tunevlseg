...
class CPUAdam(NVMeOptimizer):
    ...
    def __init__(
        ...
        nvme_offload_dir: str | None = None,
    ):
        default_args = {
            "lr": lr,
            "betas": betas,
        ...
        super().__init__(
            model_params, default_args, nvme_offload_fraction, nvme_offload_dir
        )
        ...
        self.cpu_adam_op = cpu_adam.CPUAdamOptimizer(
            lr, betas[0], betas[1], eps, weight_decay, adamw_mode
        )
