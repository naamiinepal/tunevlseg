...
def split_row_copy(smooth_linear, para_linear, tp_size=1, tp_rank=0, split_num=1):
    qweights = smooth_linear.weight.split(
        smooth_linear.out_features // split_num, dim=0
    )
    ...
    for i in range(split_num):
        para_linear.weight[
            i * smooth_split_out_features : (i + 1) * smooth_split_out_features, :
        ] = qweights[i][
            tp_rank * smooth_split_out_features : (tp_rank + 1)
            * smooth_split_out_features,
            :,
        ]
...
def split_column_copy(smooth_linear, para_linear, tp_rank=0, split_num=1):
    qweights = smooth_linear.weight.split(
        smooth_linear.in_features // split_num, dim=-1
    )
    ...
    for i in range(split_num):
        para_linear.weight[
            :, i * smooth_split_in_features : (i + 1) * smooth_split_in_features
        ] = qweights[i][
            :,
            tp_rank * smooth_split_in_features : (tp_rank + 1)
            * smooth_split_in_features,
        ]
...
class RowW8A8B8O8Linear(W8A8B8O8Linear, ParallelModule):
    ...
    def from_native_module(
        ...
        **kwargs,
        ...
        linear_1d = RowW8A8B8O8Linear(
            module.in_features, module.out_features // tp_size
        )
...
class ColW8A8B8O8Linear(W8A8B8O8Linear, ParallelModule):
    ...
    def from_native_module(
        ...
        **kwargs,
        ...
        linear_1d = ColW8A8B8O8Linear(
            module.in_features // tp_size, module.out_features
        )
        linear_1d.tp_size = tp_size
        linear_1d.tp_rank = tp_rank
        linear_1d.process_group = process_group
...
class RowW8A8BFP32O32LinearSiLU(W8A8BFP32O32LinearSiLU, ParallelModule):
    ...
    def from_native_module(
        ...
        **kwargs,
        ...
        linear_1d = RowW8A8BFP32O32LinearSiLU(
            module.in_features, module.out_features // tp_size
        )
        linear_1d.tp_size = tp_size
        linear_1d.tp_rank = tp_rank
...
class RowW8A8BFP32OFP32Linear(W8A8BFP32OFP32Linear, ParallelModule):
    ...
    def from_native_module(
        ...
        **kwargs,
        ...
        linear_1d = RowW8A8BFP32OFP32Linear(
            module.in_features, module.out_features // tp_size
        )
        linear_1d.tp_size = tp_size
        linear_1d.tp_rank = tp_rank
...
class ColW8A8BFP32OFP32Linear(W8A8BFP32OFP32Linear, ParallelModule):
    ...
    def from_native_module(
        ...
        **kwargs,
        ...
        linear_1d = ColW8A8BFP32OFP32Linear(
            module.in_features // tp_size, module.out_features
        )
        linear_1d.tp_size = tp_size
        linear_1d.tp_rank = tp_rank
