...
class LlamaModelInferPolicy(LlamaForCausalLMPolicy):
    ...
    def module_policy(self):
        ...
        if self.shard_config.extra_kwargs.get("quant", None) == "gptq":
            from colossalai.inference.quant.gptq.cai_gptq import (
                ColCaiQuantLinear,
                RowCaiQuantLinear,
            )
            ...
            from colossalai.inference.quant.smoothquant.models.llama import (
                LlamaSmoothquantDecoderLayer,
            )
        ...
        self.append_or_create_method_replacement(
            description=method_replacement, policy=policy, target_key=LlamaModel
        )
    ...
    def get_held_layers(self) -> list[Module]:
        ...
        if stage_manager.is_first_stage():
            held_layers.extend((module.embed_tokens, self.model.lm_head))
