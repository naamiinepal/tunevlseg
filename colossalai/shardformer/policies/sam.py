...
__all__ = ["SamModelPolicy", "SamPolicy"]
    ...
    def module_policy(self):
        ...
        if self.shard_config.enable_tensor_parallelism:
            ...
            policy[SamVisionAttention] = ModulePolicyDescription(
                attribute_replacement={
                    "dropout_layer": col_nn.DropoutForParallelInput(
                        self.model.config.vision_config.attention_dropout
                    )
                },
        ...
        if self.shard_config.enable_flash_attention:
            warnings.warn(
                "Flash attention is not supported in SAM model. Fallback to normal attention."
            )
