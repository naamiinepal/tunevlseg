...
_POLICY_LIST = {
    ...
    # T5
    "transformers.models.t5.modeling_t5.T5Model": PolicyLocation(
        file_name="t5", class_name="T5ModelPolicy"
    ),
    ...
    "transformers.models.t5.modeling_t5.T5EncoderModel": PolicyLocation(
        file_name="t5", class_name="T5EncoderPolicy"
    ),
    # GPT2
    ...
    # GPTJ
    "transformers.models.gptj.modeling_gptj.GPTJModel": PolicyLocation(
        file_name="gptj", class_name="GPTJModelPolicy"
    ),
    ...
    # Sam
    "transformers.models.sam.modeling_sam.SamModel": PolicyLocation(
        file_name="sam", class_name="SamModelPolicy"
    ),
    # Blip2
...
def get_autopolicy(model: nn.Module) -> Policy:
    ...
    policy_location = _POLICY_LIST.get(full_name)
