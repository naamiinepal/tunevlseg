...
) -> tuple[torch.Tensor | dict | None, torch.Tensor | dict | None]:
        ...
        if shard_config.enable_flash_attention:
            ...
            if encoder_attention_mask is None:
                encoder_attention_mask = torch.ones(
                    encoder_hidden_shape, device=encoder_hidden_states.device
                )
...
class GPT2PipelineForwards:
    ...
    def gpt2_lmhead_model_forward(
        ...
        stage_index: list[int] | None = None,
        shard_config: ShardConfig = None,
    ) -> dict | tuple | CausalLMOutputWithCrossAttentions:
        r"""
    ...
    def gpt2_double_heads_model_forward(
        ...
        stage_index: list[int] | None = None,
        shard_config: ShardConfig = None,
    ) -> dict | tuple | GPT2DoubleHeadsModelOutput:
        r"""
    ...
    def gpt2_for_question_answering_forward(
        ...
        stage_index: list[int] | None = None,
        shard_config: ShardConfig = None,
    ) -> dict | tuple | QuestionAnsweringModelOutput:
        r"""
    ...
    def gpt2_for_token_classification_forward(
        ...
        stage_index: list[int] | None = None,
        shard_config: ShardConfig = None,
    ) -> dict | tuple | TokenClassifierOutput:
        r"""
        labels (`torch.LongTensor` of shape `(batch_size, sequence_length)`, *optional*):
    ...
    def gpt2_for_sequence_classification_forward(
        ...
        stage_index: list[int] | None = None,
        shard_config: ShardConfig = None,
    ) -> dict | tuple | SequenceClassifierOutputWithPast:
        r"""
...
def get_gpt2_flash_attention_forward():
    ...
    def forward(
        ...
        attention_mask: dict | None = None,
        head_mask: torch.FloatTensor | None = None,
        encoder_hidden_states: torch.Tensor | None = None,
        encoder_attention_mask: dict | None = None,
        ...
        attn_output = ColoAttention.attention(
            query, key, value, **attention_mask, dropout_p=dropout_p, scale=scale
        )
