...
class GPTJPipelineForwards:
    ...
    def gptj_model_forward(
    ...
    ) -> dict | tuple | BaseModelOutputWithPast:
        ...
        if stage_manager.is_first_stage():
            ...
            _batch_size, seq_length = input_shape[0], input_shape[1]
        ...
        attention_mask = _get_attention_mask(
            self, shard_config, hidden_states, past_key_values, attention_mask
        )
    ...
    def gptj_causallm_model_forward(
        ...
        stage_index: list[int] | None = None,
        shard_config: ShardConfig = None,
    ) -> dict | tuple | CausalLMOutputWithPast:
        r"""
...
def get_gptj_flash_attention_forward():
    ...
    def forward(
        ...
        attn_output = ColoAttention.attention(
            query, key, value, **attention_mask, dropout_p=dropout_p
        )
